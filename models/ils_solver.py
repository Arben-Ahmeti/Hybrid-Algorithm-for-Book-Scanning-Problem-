...
class ILS_Solver:
    def iterated_local_search(self, data, current_solution, time_limit=10, max_iterations=100, pool_size=1):
        """
        ...
        while time.time() - start_time < time_limit and iteration < max_iterations:
            ...
            if improved_solution.fitness_score > current_solution.fitness_score:
                ...
                quality_diff = (
                                           current_solution.fitness_score - improved_solution.fitness_score) / current_solution.fitness_score
